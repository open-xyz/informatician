  ...
  return (
    <div className="row download">
      <div className="left col-lg-6 col-md-6 position-relative d-flex align-items-start justify-content-center">
        ...
        <img className="rounded-5" src={mobile} alt="mobile" data-aos="fade-left" data-aos-duration="500"/>
      </div>
      <div className="right col-lg-6 col-md-6" data-aos="fade-right" data-aos-duration="500">
        ...
        <div
          className="flex flex-col items-center justify-start flex-shrink-0 mt-6 space-y-4 sm:flex-row sm:space-y-0 sm:space-x-4 lg:ml-4 lg:mt-0"
          >
