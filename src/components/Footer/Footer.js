...
<footer className="bg-gray-100">
    <div className="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
        <div className="md:flex md:justify-between">
          <div className="mb-6 md:mb-0">
              <a href="#" className="flex items-center">
                  ...
                  <span className="self-center text-2xl font-bold whitespace-nowrap">Informatician</span>
              </a>
          </div>
          <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
              <div>
                  ...
                  <ul className="text-gray-600 font-medium">
                      <li className="mb-4">
                          <a href="#" className="hover:underline">About Informatician</a>
                      ...
                      <li >
                          <a href="#" className="hover:underline">Join our team!</a>
      ...
      <div className="sm:flex sm:items-center sm:justify-between">
          <span className="text-sm font-bold text-gray-900  sm:text-center ">© 2023 <a href="#" className="hover:underline">Informatician™</a>. All Rights Reserved.
          </span>
          <div className="flex mt-0 space-x-6 sm:justify-center sm:mt-0">
              ...
              <a href="#" className="text-gray-900 hover:text-red-900 ">
