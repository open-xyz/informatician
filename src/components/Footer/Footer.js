                        ...
                        <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
                            <div>
                                ...
                                <ul className="text-gray-600 font-medium">
                                    ...
                                    <li >
                                        <Link to="#" className="hover:underline  hover:text-gray-900">Join our team!</Link>
                            ...
                            <div>
                                ...
                                <ul className="text-gray-600  font-medium">
                                    ...
                                    <li className="mb-4">
                                        <Link to="#" className="hover:underline  hover:text-gray-900">Accessibility</Link>
                                    </li>
                                    <li className="mb-4">
                                        <Link to="#" className="hover:underline   hover:text-gray-900">Publishers</Link>
                                    </li>
                                    <li >
                                        <Link to="#" className="hover:underline  hover:text-gray-900">AdChoices</Link>
                                    </li>
                                </ul>
                            </div>
                            <div>
                                ...
                                <ul className="text-gray-600  font-medium">
                                    ...
                                    <li className="mb-4">
                                        <Link to="#" className="hover:underline  hover:text-gray-900">Copyright</Link>
                                    </li>
                                    <li >
