...
const TermsAndService = lazy(() => import("../pages/Terms/Terms&Service"));
const PrivacyPolicy = lazy(() => import("../pages/Privacy/PrivacyPolicy"));
const CookiePolicy = lazy(() => import("../pages/Cookies/Cookie"));
const FaqHelp = lazy(() => import("./FAQ/faq"));
const Develop = lazy(() => import("../pages/Develop/develop"));
...
const Join = lazy(() => import("../pages/JoinOurTeam/Join"));
...
const CopyrightPage = lazy(() => import("../pages/Copyright/Copyright"));
