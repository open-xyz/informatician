    ...
    <div className="benefits-container" style={{marginTop: 20, backgroundColor: props.theme==='dark'?'black' : '#f6f6f6'}}>
      <div className="container">
        ...
        <div className="benefit" style={{marginTop: 20, backgroundColor: props.theme==='dark'?'rgb(22, 19, 19)' : '#f6f6f6'}}>
          <div className="benefit-content">
            <div className="benefit-image">
              <img src={img1} alt="Knowledge Expansion" style={{height: 220, width: 400}}/>
            </div>
        ...
        <div className="benefit" style={{marginTop: 20, backgroundColor: props.theme==='dark'?'rgb(22, 19, 19)' : '#f6f6f6'}}>
          <div className="benefit-content">
            <div className="benefit-image">
              <img src={img2} alt="Mental Stimulation" style={{height: 220, width: 400}}/>
            </div>
            <div className="benefit-details">
        ...
        <div className="benefit" style={{marginTop: 20, backgroundColor: props.theme==='dark'?'rgb(22, 19, 19)' : '#f6f6f6'}}>
          <div className="benefit-content">
            <div className="benefit-image">
              <img src={img3} alt="Mental Stimulation" style={{height: 220, width: 400}}/>
            </div>
            <div className="benefit-details">
        ...
        <div className="benefit" style={{marginTop: 20, backgroundColor: props.theme==='dark'?'rgb(22, 19, 19)' : '#f6f6f6'}}>
          <div className="benefit-content">
            <div className="benefit-image">
              <img src={img4} alt="Mental Stimulation" style={{height: 220, width: 400}} />
            </div>
            <div className="benefit-details">
        ...
        <div className="benefit" style={{marginTop: 20, backgroundColor: props.theme==='dark'?'rgb(22, 19, 19)' : '#f6f6f6'}}>
          <div className="benefit-content">
            <div className="benefit-image">
              <img src={img5} alt="Mental Stimulation" style={{height: 220, width: 400}}/>
            </div>
            <div className="benefit-details">
