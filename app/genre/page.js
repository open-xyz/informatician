...
const GenreDetails = (props) => {
    ...
    return (
        <div className="book-formats-container mb-20" style={{ marginTop: 100 }}>
            <h1 className="text-7xl font-bold text-center">Explore Genres</h1>
            ...
            >
                <div className="" data-aos="fade-right" data-aos-duration="500">
                    <Image loading='lazy' src={mystery} className="team-member-image" alt="a group of books on a purple background" />
                </div>
                <div className="md:w-1/2 my-6 ml-5" data-aos="fade-left" data-aos-duration="500">
                    <h1 className="text-5xl mb-7 font-bold text-center">Mystery</h1>
            ...
            >
                <div className="md:w-1/2 my-6 mr-10" data-aos="fade-right" data-aos-duration="500">
                    <h1 className="text-5xl mb-7 font-bold text-center">Romance</h1>
                    <div className="team-description font-bold">
                ...
                <div className="" data-aos="fade-left" data-aos-duration="500">
                    <Image loading='lazy' src={romance} className="team-member-image" alt="a group of books on a violet background" />
                </div>
            </div>
            ...
            >
                <div className="" data-aos="fade-right" data-aos-duration="500">
                    <Image loading='lazy' src={science} className="team-member-image" alt="a stack of books on a table" />
                </div>
                <div className="md:w-1/2 my-6 ml-5" data-aos="fade-left" data-aos-duration="500">
                    <h1 className="text-5xl mb-7 font-bold text-center">Science Fiction</h1>
                    <div className="team-description font-bold">
            ...
            >
                <div className="md:w-1/2 my-6 mr-10" data-aos="fade-right" data-aos-duration="500">
                    <h1 className="text-5xl mb-7 font-bold text-center">Thriller</h1>
                    <div className="team-description font-bold">
                ...
                <div className="" data-aos="fade-left" data-aos-duration="500">
                    <Image loading='lazy' src={thriller} className="team-member-image" alt="a group of books on a blue background" />
                </div>
            </div>
            <div className="w-11/12 flex flex-wrap mx-auto justify-center items-center mt-26 py-4 mb-5 max-w-screen-2xl format-card shadow-xl shadow-black/30 dark:shadow-white/30"
            >
                <div className="" data-aos="fade-right" data-aos-duration="500">
                    <Image loading='lazy' src={horror} className="team-member-image" alt="a collage of books" />
                </div>
                <div className="md:w-1/2 my-6 ml-5" data-aos="fade-left" data-aos-duration="500">
                    <h1 className="text-5xl mb-7 font-bold text-center">Horror</h1>
                    <div className="team-description font-bold">
            ...
            >
                <div className="md:w-1/2 my-6 mr-10" data-aos="fade-right" data-aos-duration="500">
                    <h1 className="text-5xl mb-7 font-bold text-center">Biography</h1>
                    <div className="team-description font-bold">
                ...
                <div className="" data-aos="fade-left" data-aos-duration="500">
                    <Image loading='lazy' src={biography} className="team-member-image" alt="a group of books on a green background" />
                </div>
            </div>
        </div>
    );
