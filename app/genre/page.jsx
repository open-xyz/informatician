...
const GenreDetails = (props) => {
    ...
    return (
        <div className="book-formats-container" style={{ marginTop: 100 }}>
            <h1 className="text-5xl text-center py-4 font-bold">Explore Genres</h1>
            ...
            >
                <div className="" data-aos="fade-right" data-aos-duration="500">
                    <Image loading='lazy' src={mystery} className="team-member-image" alt="a group of books on a purple background" width={300} height={200}/>
                </div>
                <div className="md:w-1/2 ml-5" data-aos="fade-left" data-aos-duration="500">
                    <h1 className="text-3xl mb-7 font-bold">Mystery</h1>
            ...
            >
                <div className="md:w-1/2 mr-10" data-aos="fade-right" data-aos-duration="500">
                    <h1 className="text-3xl mb-7 font-bold">Romance</h1>
                    <p className="team-description font-bold">
                ...
                <div className="" data-aos="fade-left" data-aos-duration="500">
                    <Image loading='lazy' src={romance} className="team-member-image" alt="a group of books on a violet background" width={300} height={200}/>
                </div>
            </div>
            ...
            >
                <div className="" data-aos="fade-right" data-aos-duration="500">
                    <Image loading='lazy' src={science} className="team-member-image" alt="a stack of books on a table" width={300} height={200}/>
                </div>
                <div className="md:w-1/2 ml-5" data-aos="fade-left" data-aos-duration="500">
                    <h1 className="text-3xl mb-7 font-bold">Science Fiction</h1>
                    <p className="team-description font-bold">
            ...
            >
                <div className="md:w-1/2 mr-10" data-aos="fade-right" data-aos-duration="500">
                    <h1 className="text-3xl mb-7 font-bold">Thriller</h1>
                    <p className="team-description font-bold">
                ...
                <div className="" data-aos="fade-left" data-aos-duration="500">
                    <Image loading='lazy' src={thriller} className="team-member-image" alt="a group of books on a blue background" width={300} height={200}/>
                </div>
            </div>
            <div className="w-11/12 flex flex-wrap mx-auto justify-center items-center mt-26 py-4 mb-5 max-w-screen-2xl format-card"
                style={{ boxShadow: props.theme === 'dark' ? 'rgb(77 85 93) 0px 15px 30px 1px' : 'rgba(0, 0, 0, 0.09) 0px 2px 1px, rgba(0, 0, 0, 0.09) 0px 4px 2px,rgba(0, 0, 0, 0.09) 0px 8px 4px, rgba(0, 0, 0, 0.09) 0px 16px 8px,rgba(0, 0, 0, 0.09) 0px 32px 16px' }}
            >
                <div className="" data-aos="fade-right" data-aos-duration="500">
                    <Image loading='lazy' src={horror} className="team-member-image" alt="a collage of books" width={300} height={200}/>
                </div>
                <div className="md:w-1/2 ml-5" data-aos="fade-left" data-aos-duration="500">
                    <h1 className="text-3xl mb-7 font-bold">Horror</h1>
                    <p className="team-description font-bold">
            ...
            >
                <div className="md:w-1/2 mr-10" data-aos="fade-right" data-aos-duration="500">
                    <h1 className="text-3xl mb-7 font-bold">Biography</h1>
                    <p className="team-description font-bold">
                ...
                <div className="" data-aos="fade-left" data-aos-duration="500">
                    <Image loading='lazy' src={biography} className="team-member-image" alt="a group of books on a green background" width={300} height={200} />
                </div>
            </div>
        </div>
    );
