  ...
  return (
    <div className="md:w-1/2 mx-auto">
      ...
      >
        ...
        <button
          className="w-full flex justify-center items-center gap-2 bg-red-600 text-white px-4 py-2 shadow-md rounded-md cursor-pointer"
          onClick={() => signIn("google")}
        >
          Login with Google{" "}
          <Image src={GoogleLogo} alt="" height={50} width={50} />
        </button>
        <div className="w-full flex mx-auto items-center justify-center gap-2">
        ...
        <div className="w-full flex flex-col items-start gap-2">
          ...
          <div className="w-full relative">
            <input
              ...
              className="pl-8 w-full text-gray-800 bg-slate-100 py-2 px-4 focus:outline-indigo-500"
            />
