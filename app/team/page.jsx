      ...
      <div className="w-11/12 flex flex-wrap mx-auto justify-center gap-12 items-center mt-28 mb-5 max-w-screen-2xl">
        ...
        <div className="md:w-1/2" data-aos="fade-right" data-aos-duration="500">
          ...
          <p className="text-justify text-lg mb-8">
            ...
            Our project welcomes contributions from developers around the world. With the collective effort of the
            open-source community, we strive to build a robust and feature-rich software that addresses the needs of our
            users.
          </p>
          <Link
